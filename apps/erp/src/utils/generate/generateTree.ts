// https://github.com/philipstanislaus/performant-array-to-tree/blob/main/src/arrayToTree.ts
...
function getNestedProperty(item: Item, nestedProperty: string) {
  // eslint-disable-next-line @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unnecessary-condition, @typescript-eslint/prefer-optional-chain
